...
def is_blackjack(card_one, card_two):
    ...
    def value_of_cards(card):
        ...
        if card == 'A':
            return 11
        return int(card)
    return bool((value_of_cards(card_one) + value_of_cards(card_two) == 21))
...
def can_double_down(card_one, card_two):
    ...
    total_points = [9, 10, 11]
    return bool((value_of_card(card_one) + value_of_card(card_two)) in total_points)